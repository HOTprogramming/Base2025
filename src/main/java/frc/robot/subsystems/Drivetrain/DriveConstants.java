...
public class DriveConstants {
    ...
    private static final Angle kBackLeftEncoderOffset = Rotations.of(-0.039306640625);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(-0.287109375);
